...
- resumable sessions, with manual recovery for interrupted streams
- image paste and attachments in chat
- per-card model and reasoning-effort selection, plus Claude plan mode
- slash commands loaded from local and skill commands
- auto-urge automatic follow-up prompts
