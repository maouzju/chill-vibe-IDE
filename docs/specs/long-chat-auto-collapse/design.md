...
- expanded tool groups render the newest 20 items by default;
...
- Add pure coverage for a 300-item structured group rendering only the latest 20 items, then 80 after one reveal action, without mutating the source array.
