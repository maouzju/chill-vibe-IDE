...
export const getStructuredLabels = (language: AppLanguage) => {
  if (language === 'en') {
    return {
      ...
      olderActivityHidden: (count: number) => `${count} earlier activities hidden`,
      revealOlderActivity: (count: number) => `Show ${count} earlier`,
      running: 'Running',
      completed: 'Completed',
      declined: 'Declined',
      ...
      subAgentsRunning: 'Sub-agents running',
      noSubAgentsRunning: 'No sub-agents running.',
      noRecentAgentActivity: 'No recent activity yet.',
  ...
  return {
    ...
    olderActivityHidden: (count: number) => `\u5DF2\u6536\u8D77\u8F83\u65E9\u7684 ${count} \u6761\u6D3B\u52A8`,
    revealOlderActivity: (count: number) => `\u518D\u663E\u793A ${count} \u6761`,
    running: '\u8FDB\u884C\u4E2D',
    completed: '\u5DF2\u5B8C\u6210',
    declined: '\u5DF2\u62D2\u7EDD',
    ...
    tasks: '\u4EFB\u52A1',
    agents: '\u540E\u53F0\u667A\u80FD\u4F53',
    subAgentsRunning: '\u6B63\u5728\u8FD0\u884C\u7684\u5B50\u667A\u80FD\u4F53',
    noSubAgentsRunning: '\u6CA1\u6709\u6B63\u5728\u8FD0\u884C\u7684\u5B50\u667A\u80FD\u4F53\u3002',
    noRecentAgentActivity: '\u6682\u65E0\u8FD1\u671F\u6D3B\u52A8\u3002',
