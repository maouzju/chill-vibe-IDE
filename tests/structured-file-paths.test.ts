...
test('resolveOpenableFilePath opens out-of-workspace absolute paths with their absolute path', () => {
  assert.equal(
    resolveOpenableFilePath('D:/Git/chill-vibe', 'C:\\Users\\yuze\\.claude\\projects\\demo\\MEMORY.md'),
    'C:/Users/yuze/.claude/projects/demo/MEMORY.md',
  )
  assert.equal(
...
test('resolveOpenableFilePath preserves drive letter casing for out-of-workspace paths', () => {
  ...
  assert.equal(
    resolveOpenableFilePath('D:/Git/chill-vibe', 'c:/Users/yuze/.claude/plans/plan.md'),
    'c:/Users/yuze/.claude/plans/plan.md',
  )
})
