  ...
  state.columns[0]!.cards[0]!.messages = [
    {
      ...
      meta: {
        ...
        structuredData: JSON.stringify({
          ...
          files: [
            {
              path: 'D:\\Git\\example-game\\client\\Assets\\Scripts\\Game\\Backpack\\System\\BazEffects\\EconomyShop\\sample-effect.meta',
              kind: 'added',
              addedLines: 11,
              removedLines: 0,
              patch: [
                'diff --git a/Assets/Scripts/Game/Backpack/System/BazEffects/EconomyShop/sample-effect.meta b/Assets/Scripts/Game/Backpack/System/BazEffects/EconomyShop/sample-effect.meta',
                'new file mode 100644',
                'index 0000000..abc1234',
                '--- /dev/null',
                '+++ b/Assets/Scripts/Game/Backpack/System/BazEffects/EconomyShop/sample-effect.meta',
                '@@ -0,0 +1,11 @@',
                '+fileFormatVersion: 2',
...
test('structured edited-file overflow actions stay quiet across themes', async ({ page }) => {
  ...
  await expect(editsCard).toContainText('sample-effect.meta')
